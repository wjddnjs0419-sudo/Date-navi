...
import { Coffee, Footprints, Palette, Utensils, Wine, Zap } from 'lucide-react-native';
...
function render(steps: CourseDraftStep[], extra: { onToggleCategory?: jest.Mock; onSelectPreference?: jest.Mock } = {}) {
